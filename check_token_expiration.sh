...
let timelimit="7*24*60*60" # 1 week

expiration_timestamp=$(curl "https://graph.facebook.com/v11.0/debug_token?access_token=$IG_ACCESS_TOKEN&debug=all&format=json&input_token=$IG_ACCESS_TOKEN" | jq -r -c ".data.expires_at")
